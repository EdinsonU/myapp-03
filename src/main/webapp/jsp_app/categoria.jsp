<%-- 
    Document   : index
    Created on : 17-jul-2019, 19:12:24
    Author     : edinson
--%>
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    ...
                    <br>
                    <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>Euriarte</strong></h6>
                </div>
                <div class="main-menu">
                                    ...
                                    <form id="FrmCategoria">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <button type="sumbit"id="btnBuscarCategoria" class="btn btn-primary btn-xs mr-3"><i class="fa fa-search"></i> BUSCAR</button>
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2018 <a href="https://colorlib.com/wp/">Euriarte</a>.</p>
                </div>
            </footer>
            <!-- footer area end-->
        </div>
